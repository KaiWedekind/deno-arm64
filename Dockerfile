...
RUN [ "$TARGETPLATFORM" == "linux/arm64" ] && curl -Lsf https://github.com/KaiWedekind/docker-deno/releases/download/${VERSION}/deno-$(echo $TARGETPLATFORM | tr '/' '-').zip -o deno.zip || true
